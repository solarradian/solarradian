...
//             <NavLink to="/blogcontainer" className="hover:text-yellow-500 flex items-center"><FaNewspaper className="mr-1" /> Blog</NavLink>
...
//         <div
//           className={`fixed top-0 left-0 h-full w-[70%] bg-white shadow-lg transform transition-transform duration-300 z-50 ${mobileOpen ? "translate-x-0" : "-translate-x-full"
//             }`}
//         >
...
//           <nav className="flex flex-col space-y-4 px-6 py-6 text-gray-700 font-semibold">
//             <NavLink to="/" onClick={handleDrawerToggle}><FaHome className="inline mr-2" /> Home</NavLink>
//             <NavLink to="/about" onClick={handleDrawerToggle}><FaUsers className="inline mr-2" /> About</NavLink>
//             <NavLink to="/rooftopsolar" onClick={handleDrawerToggle}><FaSolarPanel className="inline mr-2" /> Rooftop Solar</NavLink>
//             <NavLink to="/pmsurayghar" onClick={handleDrawerToggle}><FaCloudSun className="inline mr-2" /> PM Surya Ghar</NavLink>
//             <NavLink to="/delhi-solar-energy-policy" onClick={handleDrawerToggle}><FaSun className="inline mr-2" /> Delhi Solar Policy</NavLink>
//             <NavLink to="/blogcontainer" onClick={handleDrawerToggle}><FaNewspaper className="inline mr-2" /> Blog</NavLink>
//             <NavLink to="/partner" onClick={handleDrawerToggle}><FaHandshake className="inline mr-2" /> Become a Partner</NavLink>
//             <NavLink to="/contact" onClick={handleDrawerToggle}><FaPhoneAlt className="inline mr-2" /> Contact</NavLink>
...
//                 </div>
//               ) : (
//                 <button onClick={redirectToLoginPage} className='font-semibold text-left flex align-center '> <FaUserPlus size={26} className='pr-2' /> Signup / Login</button>
//               )
//             }
//           </nav>
//         </div>
