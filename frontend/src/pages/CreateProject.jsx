...
//           // Debug: Check if there are customers
...
//     if (formData.panelsData.length === 0 ||
//       !formData.panelsData[0].brand || !formData.panelsData[0].model ||
//       !formData.panelsData[0].serialNumber || !formData.panelsData[0].capacity) {
//       newErrors.panels = "At least one Panel with complete details is required";
//     }
...
//                     className={`w-full border p-2 rounded ${errors.panels ? 'border-red-500' : 'border-gray-300'}`}
//                   />
//                 </div>
//                 <div>
//                   <label className="block text-sm font-medium mb-1">Model</label>
